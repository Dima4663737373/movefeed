module mines::move_feed_v10 {
    ...
    public fun get_user_posts_paginated(user_addr: address, page: u64, limit: u64): (vector<Post>, u64) acquires GlobalFeed {
        ...
        // We want to return from end-start_index down to end-end_index ?
        // Actually, if we collected them in order 0..N (Oldest..Newest),
        // To return Newest first:
        // Page 0 (Limit 10) of 100 posts -> Indices 90..99.
        // Reversed: 99, 98.. 90.
