 ...
 * Cashtag Page
 * 
 * Displays posts containing a specific cashtag ($TICKER)
 */
...
import { extractCashtags } from "@/utils/textUtils";
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            const filteredPosts = allPosts.filter(post => {
                const cashtags = extractCashtags(post.content).map(t => t.toLowerCase());
                return tag && cashtags.includes((tag as string).toLowerCase());
            });
